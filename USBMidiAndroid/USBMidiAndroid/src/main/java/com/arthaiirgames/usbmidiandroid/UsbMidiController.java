...
public class UsbMidiController {
    ...
    public static UsbMidiController getInstance() { return (_instance); }
    ...
    public void registerMidiDevices()
    {
        ...
        for (UsbDevice usbDevice : map.values())
        {
            try
            {
                PendingIntent permissionIntent = PendingIntent.getBroadcast(_context, 0, new Intent(USB_PERMISSION_ACTION), 0);
